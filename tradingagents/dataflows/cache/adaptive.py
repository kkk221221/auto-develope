...
class AdaptiveCacheSystem:
    ...
    def _get_cache_key(self, symbol: str, start_date: str = "", end_date: str = "",
        ...
        """生成缓存键"""
        key_data = f"{symbol}_{start_date}_{end_date}_{data_source}_{data_type}_{period}"
    ...
    def save_data(self, symbol: str, data: Any, start_date: str = "", end_date: str = "",
        ...
        """保存数据到缓存"""
        # 生成缓存键
        cache_key = self._get_cache_key(symbol, start_date, end_date, data_source, data_type, period)
